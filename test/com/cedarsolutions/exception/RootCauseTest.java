...
public class RootCauseTest {
    ...
    @Test public void testConstructors() {
        ...
        assertNull(rootCause.getStackTrace());
        assertNull(rootCause.getCause());

        RootCause nested = new RootCause();

        rootCause = new RootCause("a", "b", "c", "d", "e", "f", nested);
        ...
        assertEquals("f", rootCause.getStackTrace());
    ...
    @Test public void testEquals() {
        ...
        rootCause1 = new RootCause("a", "b", "c", "d", "e", "f", nested);
        rootCause2 = new RootCause("a", "b", "c", "d", "e", "f", nested);
        ...
        rootCause1 = new RootCause("a", "b", "c", "d", "e", "f", nested);
        rootCause2 = new RootCause("X", "b", "c", "d", "e", "f", nested);
        assertFalse(rootCause1.equals(rootCause2));
        assertFalse(rootCause2.equals(rootCause1));

        rootCause1 = new RootCause("a", "b", "c", "d", "e", "f", nested);
        rootCause2 = new RootCause("a", "X", "c", "d", "e", "f", nested);
        assertFalse(rootCause1.equals(rootCause2));
        assertFalse(rootCause2.equals(rootCause1));

        rootCause1 = new RootCause("a", "b", "c", "d", "e", "f", nested);
        rootCause2 = new RootCause("a", "b", "X", "d", "e", "f", nested);
        assertFalse(rootCause1.equals(rootCause2));
        assertFalse(rootCause2.equals(rootCause1));

        rootCause1 = new RootCause("a", "b", "c", "d", "e", "f", nested);
        rootCause2 = new RootCause("a", "b", "c", "X", "e", "f", nested);
        assertFalse(rootCause1.equals(rootCause2));
        assertFalse(rootCause2.equals(rootCause1));

        rootCause1 = new RootCause("a", "b", "c", "d", "e", "f", nested);
        rootCause2 = new RootCause("a", "b", "c", "d", "X", "f", nested);
        assertFalse(rootCause1.equals(rootCause2));
        assertFalse(rootCause2.equals(rootCause1));

        rootCause1 = new RootCause("a", "b", "c", "d", "e", "f", nested);
        rootCause2 = new RootCause("a", "b", "c", "d", "e", "X", nested);
        assertFalse(rootCause1.equals(rootCause2));
        assertFalse(rootCause2.equals(rootCause1));

        rootCause1 = new RootCause("a", "b", "c", "d", "e", "f", nested);
        rootCause2 = new RootCause("a", "b", "c", "d", "e", "f", null);
        assertFalse(rootCause1.equals(rootCause2));
        assertFalse(rootCause2.equals(rootCause1));
    }
    ...
    @Test public void testHashCode() {
        ...
        RootCause rootCause1 = new RootCause("X", null, null, null, null, null, null);
        RootCause rootCause2 = new RootCause(null, "X", null, null, null, null, null);
        RootCause rootCause3 = new RootCause(null, null, "X", null, null, null, null);
        RootCause rootCause4 = new RootCause(null, null, null, "X", null, null, null);
        RootCause rootCause5 = new RootCause(null, null, null, null, "X", null, null);
        RootCause rootCause6 = new RootCause(null, null, null, null, null, "X", null);
        RootCause rootCause7 = new RootCause(null, null, null, null, null, null, nested);
        RootCause rootCause8 = new RootCause("X", null, null, null, null, null, null);  // same as rootCause1
        ...
        assertEquals("SEVEN", map.get(rootCause7));
        assertEquals("ONE", map.get(rootCause8));
    }
