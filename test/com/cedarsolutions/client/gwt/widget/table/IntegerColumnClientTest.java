...
/**
 * Client-side unit tests for IntegerColumn.
 * @author Kenneth J. Pronovici <pronovic@ieee.org>
 */
public class IntegerColumnClientTest extends ClientTestCase {

    /** Test constructor and getName() method. */
    public void testConstructor() {
        IntegerColumn<Row> column  = new TestColumn();
    ...
    private static class TestColumn extends IntegerColumn<Row> {
        TestColumn() {
            super();
        }
        ...
        @Override
        protected Integer getField(Row item) {
