...
public class ClientTestSuite extends GWTTestSuite {
    ...
    public static Test suite() throws Exception {
        ...
        // or nothing will happen.  As of this writing, they go to build/test/classes.
        return GwtTestSuiteBuilder.generateSuite("suites.ClientTestSuite", "build/test/classes/test");
    }
