...
public interface IPropertiesService {
     ...
     */
    Properties loadProperties(String... paths) throws InvalidDataException;
     ...
     */
    List<String> getMatchingPrefixes(Properties properties, String parentPrefix);
     ...
     */
    List<String> getMatchingChildren(Properties properties, String parentPrefix);
