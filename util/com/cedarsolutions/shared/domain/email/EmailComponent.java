...
/**
 * Standard components of an email template.
 * @author Kenneth J. Pronovici <pronovic@ieee.org>
 */
@SuppressWarnings("serial")
public class EmailComponent implements Serializable {

    /** Standard name of the subject template. */
    public static final String SUBJECT = "subject.vm";

    /** Standard name of the plaintext template. */
    public static final String PLAINTEXT = "plaintext.vm";

    /** Standard name of the HTML template. */
