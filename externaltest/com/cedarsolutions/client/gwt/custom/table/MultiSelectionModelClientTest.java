 ...
 */
// Modified for CedarCommon (original was MultiSelectionModelTest).
// These are the same as the original tests, but use SwitchableSelectionModel instead.
// That way, SwitchableSelectionModel in MULTI mode is equivalent to the standard MultiSelectionModel.
public class MultiSelectionModelClientTest extends AbstractSelectionModelTest {
  ...
  /**
   * Clearing an empty {@link SwitchableSelectionModel} should not fire an event,
  ...
  protected SwitchableSelectionModel<String> createSelectionModel(ProvidesKey<String> keyProvider) {
    return new SwitchableSelectionModel<String>(keyProvider, SelectionType.MULTI);
  }
}
